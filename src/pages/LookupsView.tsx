...
const LookupsView = () => {
  ...
  return (
    <div className="grid">
      ...
      <LookupFormDialogView isOpen={openDialog} toggle={toggleOpenDialog} messageRef={message} record={selectedUser} reloadFn={fetchRecordsFromServer}></LookupFormDialogView>
    </div>
  );
};

        ...
        <div className="card grid grid-nogutter widget-sales block sm:flex">
          <div className="lg:col-3 md:col-6 sm:col-12 p-0">
            <div className="sales-info flex flex-column p-4">
              ...
              <span className="fs-large mt-2">
                {storeADiff !== 0 && (
                  <i className={classNames("fw-700 fs-large pi", { "pr-1": !isRTL, "pl-1": isRTL, "pi-arrow-up green-color": storeADiff > 0, "pi-arrow-down pink-color": storeADiff < 0 })}></i>
                )}
                ${storeATotalValue}
                {storeADiff !== 0 && (
          ...
          <div className="lg:col-3 md:col-6 sm:col-12 p-0">
            <div className="sales-info flex flex-column p-4">
              ...
              <span className="fs-large mt-2">
                {storeBDiff !== 0 && (
                  <i className={classNames("fw-700 fs-large pi", { "pr-1": !isRTL, "pl-1": isRTL, "pi-arrow-up green-color": storeBDiff > 0, "pi-arrow-down pink-color": storeBDiff < 0 })}></i>
                )}
                ${storeBTotalValue}
                {storeBDiff !== 0 && (
          ...
          <div className="lg:col-3 md:col-6 sm:col-12 p-0">
            <div className="sales-info flex flex-column p-4">
              ...
              <span className="fs-large mt-2">
                {storeCDiff !== 0 && (
                  <i className={classNames("fw-700 fs-large pi", { "pr-1": !isRTL, "pl-1": isRTL, "pi-arrow-up green-color": storeCDiff > 0, "pi-arrow-down pink-color": storeCDiff < 0 })}></i>
                )}
                ${storeCTotalValue}
                {storeCDiff !== 0 && (
          ...
          <div className="lg:col-3 md:col-6 sm:col-12 p-0">
            <div className="sales-info flex flex-column p-4">
              ...
              <span className="fs-large mt-2">
                {storeDDiff !== 0 && (
                  <i className={classNames("fw-700 fs-large pi", { "pr-1": !isRTL, "pl-1": isRTL, "pi-arrow-up green-color": storeDDiff > 0, "pi-arrow-down pink-color": storeDDiff < 0 })}></i>
                )}
                ${storeDTotalValue}
                {storeDDiff !== 0 && (

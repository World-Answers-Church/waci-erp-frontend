...
import MemberDetailsForm from "../../../pages/MemberDetailsView";
...
export class NormalUserRoutes extends BaseFrontendRoutes {
  ...
  getNavigationMenu(): any[] {
    ...
    menuItems.push({
      ...
      to: PLEDGES_ROUTE_PATH,
      exact: true,
    });
    menuItems.push({
      label: "PledgePayments",
      icon: PrimeIcons.DOLLAR,
      to: PLEDGE_PAYMENTS_ROUTE_PATH,
      exact: true,
    });
    menuItems.push({
      label: "Fundraisings",
      icon: PrimeIcons.HEART_FILL,
      to: FUNDRAISINGS_ROUTE_PATH,
      exact: true,
    });
  ...
  getAuthenticatedComponetRouters(): any[] {
    ...
    routes.push({
      path: PLEDGES_ROUTE_PATH,
      label: "Pledges",
      component: PledgesView,
      exact: true,
    });
    routes.push({
      path: FUNDRAISINGS_ROUTE_PATH,
      label: "Fundraisings",
      component: FundraisingCausesView,
      exact: true,
    });
    routes.push({
      path: PLEDGE_PAYMENTS_ROUTE_PATH,
      label: "PledgePayments",
      component: PledgePaymentsView,
      exact: true,
    });
